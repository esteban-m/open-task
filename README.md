...
| **Documentation** | [![Docs](https://github.com/esteban-m/open-task/actions/workflows/docs.yml/badge.svg)](https://github.com/esteban-m/open-task/actions/workflows/docs.yml) [![GitHub Pages](https://img.shields.io/badge/Pages-portail%20dev-2563eb?style=flat-square)](https://esteban-m.github.io/open-task/) [![VitePress](https://img.shields.io/badge/Docs-VitePress-646cff?style=flat-square)](https://esteban-m.github.io/open-task/docs/) [![Histoire](https://img.shields.io/badge/UI-Histoire-ff4785?style=flat-square)](https://esteban-m.github.io/open-task/histoire/) [![Swagger](https://img.shields.io/badge/API-Swagger-85ea2d?style=flat-square)](https://esteban-m.github.io/open-task/swagger/) |
| **Runtime** | [![Node.js](https://img.shields.io/badge/Node.js-24-339933?logo=node.js&logoColor=white)](https://nodejs.org/) [![TypeScript](https://img.shields.io/badge/TypeScript-5.9-3178C6?logo=typescript&logoColor=white)](https://www.typescriptlang.org/) [![Docker](https://img.shields.io/badge/Docker-Compose-2496ED?logo=docker&logoColor=white)](https://docs.docker.com/compose/) |
...
[Démarrage rapide](#démarrage-rapide) · [Guide d’utilisation](USAGE.md) · [Documentation](https://esteban-m.github.io/open-task/) · [Fonctionnalités](#fonctionnalités) · [Architecture](#architecture) · [Sécurité](#sécurité) · [Tests](#tests) · [Contribuer](#contribuer)
...
Voir le **[guide complet](USAGE.md)** (inscription, listes, tâches, vues, connexion, mobile, thèmes, Kanban drag & drop, calendrier, partage).
...
| **Ops** | Docker (Node 24), Docker Compose, GitHub Actions (CI, CodeQL, Docs → Pages, Codecov) |
...
**Site en ligne : [https://esteban-m.github.io/open-task/](https://esteban-m.github.io/open-task/)** — portail vers [documentation](https://esteban-m.github.io/open-task/docs/), [composants UI](https://esteban-m.github.io/open-task/histoire/) et [Swagger](https://esteban-m.github.io/open-task/swagger/).
